<template>
  <div class="modal-body">
    ...
    <div>
      ...
      <p>En el presente Aviso se describe cómo realizaremos el Tratamiento y protegemos tus Datos Personales.</p>
    </div>

    <div>
      <p>
        <strong>1. Fines para los cuales Tratamos tus Datos Personales.</strong>
      </p>
      <p>
      ...
      <p>
        <strong>1.1 Identificación y mayoría de edad.</strong>
        Esta finalidad se refiere a la confirmación de la identidad del Titular, según sea necesario para dar cumplimiento a las finalidades previstas en el presente Aviso, así como para verificar, en su caso, la mayoría de edad del Titular previo a su ingreso a cualquiera de las páginas oficiales de Internet de Heineken México y/o a su participación en las actividades promocionadas u organizadas por éste último.
      </p>

      <p>
        <strong>1.2 Cumplimiento con la Ley.</strong>
        Esta finalidad hace referencia al Tratamiento de Datos Personales de los Titulares según sea necesario para realizar una actividad tendiente a dar cumplimiento a una obligación o requerimiento legal, o a una recomendación de autoridad de la cual Heineken México, sus filiales o subsidiarias sean sujetos, incluyendo la revelación de Datos Personales a autoridades de gobierno o supervisoras, tales como autoridades fiscales.
      </p>

      <p>Adicionalmente, utilizaremos tus Datos Personales para las siguientes finalidades no necesarias:</p>

      <p>
        <strong>1.3 Servicio al cliente.</strong>
        Esta finalidad incluye actividades tales como atender y dar seguimiento a las dudas, quejas o comentarios del Titular en relación con nuestros productos, motivo por el cual pudieran grabarse las llamadas telefónicas, correos electrónicos o cualquier tipo de comunicación entre el Titular y Heineken México, así como para evaluar la calidad nuestros productos y realizar registros, reportes y estadísticas relacionadas a la información obtenida. 
      </p>

      <p>
        <strong>1.4 Publicidad y mercadotecnia.</strong>
        Esta finalidad hace referencia a actividades tales como el envío de información publicitaria sobre nuestros productos, desarrollo y envío de campañas de mercadotecnia o publicidad para ofrecer productos y/o servicios de Heineken México, sus filiales, subsidiarias y/o socios comerciales.
      </p>
      ...
      <p>
        <strong>2. Tipos de Datos Personales sujetos a Tratamiento.</strong>
      </p>
      <p>
      ...
      <p>
        Lo anterior, incluyendo aquella información que compartas a Heineken México a través de cualquiera de tus
        redes sociales, en caso de que las utilices como medio de registro en nuestras páginas web.
      </p>
      ...
      <p>
        <strong>3. Quién tiene acceso a tus Datos Personales.</strong>
      </p>
      <p>
      ...
      <p>
        - Empresas del grupo Heineken, con el propósito de brindar de forma central diversos procesos y servicios,
        derivado de la naturaleza internacional de los sistemas de tecnología de información que se comparten dentro del grupo Heineken;
      </p>

      <p>
        - Terceros proveedores de productos o servicios. Estos productos o servicios pueden incluir servicios de
        mercadotecnia, publicidad, concursos y sistemas de tecnología de información;
      </p>

      <p>- Consultores profesionales, tales como contadores, auditores o abogados;</p>

      <p>
        - En caso de que vendamos a algún tercero la totalidad o parte de los activos o acciones de una compañía
        perteneciente al grupo Heineken, a la cual anteriormente se le habían compartido tus Datos Personales,
        dichos Datos podrían llegar a ser compartidos con el citado tercero;
      </p>

      <p>- Autoridades gubernamentales, a fin de dar cumplimiento a cualquier obligación legal o judicial.</p>
      ...
      <p>
        <strong>5. Plazos por los cuales conservamos tus Datos Personales.</strong>
      </p>
      <p>
      ...
      <p>
        <strong>6. Tratamiento de Datos Personales de un Tercero Relacionado.</strong>
      </p>
      <p>
      ...
      <p>
        <strong>7. Tratamiento de Datos Personales de menores de edad y/o personas en estado de interdicción.</strong>
      </p>
      <p>
      ...
      <p>
        • La obtención del consentimiento de los padres o tutores legales por medios físicos o electrónicos, según sea aplicable,
        para el Tratamiento de los Datos Personales de este grupo de personas.
      </p>
      <p>
        • La verificación de la autenticidad del consentimiento otorgado por los padres o tutores, solicitando
        los documentos legales que acrediten su carácter.
      </p>

      <p>
        <strong>8. Acceso, rectificación, cancelación, oposición, preguntas y quejas.</strong>
      </p>
      <p>
      ...
      <p>
        <strong>9. Uso de tecnología “Cookie” en el Sitio Web</strong>
      </p>
      <p>
      ...
      <p>Los siguientes enlaces pueden ayudarte a administrar tu configuración de “cookies”, o puedes usar la opción 'Ayuda' en tu navegador de Internet para obtener más detalles:</p>
      <p>
      ...
      <p>
        ...
        <a
          ...
          target="_blank"
        >http://support.mozilla.com/en-US/kb/Cookies</a>
      </p>
      <p>
        Para Google Crome:
        <a
          href="http://www.google.com/support/chrome/bin/answer.py?hl=es&answer=95647"
          target="_blank"
        >http://www.google.com/support/chrome/bin/answer.py?hl=es&answer=95647</a>
      </p>
      <p>
        Safari:
        <a
      ...
      <p>
        ...
        <a
          ...
          target="_blank"
        >http://www.opera.com/help/tutorials/security/privacy/</a>
      </p>
      <p>
        Adobe (cookies flash):
        <a
          href="https://www.adobe.com/support/flash/downloads.html"
          target="_blank"
        >https://www.adobe.com/support/flash/downloads.html</a>
      </p>

      <p>
        Para bloquear específicamente las “cookies” de Google Analytics, puedes instalar
        el “Google Analytics Opt-out Browser Add-on" (complemento del navegador de
        exclusión de Google Analytics) proporcionado por Google.
      </p>

      <p>
        Ten en cuenta que con el uso de la configuración de “cookies” en nuestro sitio
        web no se eliminarán “cookies” que ya se hayan configurado. Si deseas hacerlo,
        puedes realizarlo reconfigurando tu navegador web como se describe arriba,
        después de haber cambiado la Configuración de “cookies” en nuestro sitio web.
      </p>

      <p>
        <strong>10. Modificaciones al Aviso.</strong>
      </p>
      <p>
      ...
      <p>
        ...
        <a href="www.inai.org.mx." target="_blank">www.inai.org.mx.</a>
      </p>
    </div>
  </div>
</template>
