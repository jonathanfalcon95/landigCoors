...
export default {
  ...
  data() {
    return {
      ...
      carousel3Image: carousel3,
      carousel4Image: carousel4,
      carousel5Image: carousel5,
      carousel6Image: carousel6
    };
  },
  methods: {
    ...mapActions({}),
